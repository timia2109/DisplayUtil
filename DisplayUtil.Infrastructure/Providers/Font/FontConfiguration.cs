...
public record FontConfiguration
{
    ...
    {
        foreach (var font in LocalFonts) fontProviderBuilder.AddLocalFont(font.Key, font.Value);

        foreach (var font in GoogleFonts) fontProviderBuilder.AddGoogleFont(font.Key, font.Value);
