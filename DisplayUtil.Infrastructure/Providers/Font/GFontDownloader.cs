...
)
{
    ...
    {
        return Path.Combine(googleFontsPath, downloadData.FileName);
    }
    ...
    public string DownloadFont(string gfontFormat)
    {
        ...
        HandleDownloadAsync(data, path).GetAwaiter().GetResult();
